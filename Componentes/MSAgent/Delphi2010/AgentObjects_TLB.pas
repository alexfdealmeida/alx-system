...
// $Rev: 17244 $
// File generated on 22/12/2010 15:11:42 from Type Library described below.
...
// *********************************************************************//
  IAgentCtlCommands = interface(IDispatch)
    ...
    function Insert(const Name: WideString; const RefName: WideString; Before: OleVariant; 
                    Caption: OleVariant; Voice: OleVariant; Enabled: OleVariant; Visible: OleVariant): IAgentCtlCommand; safecall;
...
// *********************************************************************//
  IAgentCtlCommandsDisp = dispinterface
    ...
    function Insert(const Name: WideString; const RefName: WideString; Before: OleVariant; 
                    Caption: OleVariant; Voice: OleVariant; Enabled: OleVariant; Visible: OleVariant): IAgentCtlCommand; dispid 11;
...
// *********************************************************************//
  TAgentActivateInput = procedure(ASender: TObject; const CharacterID: WideString) of object;
  TAgentDeactivateInput = procedure(ASender: TObject; const CharacterID: WideString) of object;
  TAgentClick = procedure(ASender: TObject; const CharacterID: WideString; Button: Smallint; 
                                            Shift: Smallint; x: Smallint; y: Smallint) of object;
  TAgentDblClick = procedure(ASender: TObject; const CharacterID: WideString; Button: Smallint; 
                                               Shift: Smallint; x: Smallint; y: Smallint) of object;
  TAgentDragStart = procedure(ASender: TObject; const CharacterID: WideString; Button: Smallint; 
                                                Shift: Smallint; x: Smallint; y: Smallint) of object;
  TAgentDragComplete = procedure(ASender: TObject; const CharacterID: WideString; Button: Smallint; 
                                                   Shift: Smallint; x: Smallint; y: Smallint) of object;
  TAgentShow = procedure(ASender: TObject; const CharacterID: WideString; Cause: Smallint) of object;
  TAgentHide = procedure(ASender: TObject; const CharacterID: WideString; Cause: Smallint) of object;
  TAgentRequestStart = procedure(ASender: TObject; const Request: IDispatch) of object;
  TAgentRequestComplete = procedure(ASender: TObject; const Request: IDispatch) of object;
  TAgentBookmark = procedure(ASender: TObject; BookmarkID: Integer) of object;
  TAgentCommand = procedure(ASender: TObject; const UserInput: IDispatch) of object;
  TAgentIdleStart = procedure(ASender: TObject; const CharacterID: WideString) of object;
  TAgentIdleComplete = procedure(ASender: TObject; const CharacterID: WideString) of object;
  TAgentMove = procedure(ASender: TObject; const CharacterID: WideString; x: Smallint; y: Smallint; 
                                           Cause: Smallint) of object;
  TAgentSize = procedure(ASender: TObject; const CharacterID: WideString; Width: Smallint; 
                                           Height: Smallint) of object;
  TAgentBalloonShow = procedure(ASender: TObject; const CharacterID: WideString) of object;
  TAgentBalloonHide = procedure(ASender: TObject; const CharacterID: WideString) of object;
  TAgentHelpComplete = procedure(ASender: TObject; const CharacterID: WideString; 
                                                   const Name: WideString; Cause: Smallint) of object;
  TAgentListenStart = procedure(ASender: TObject; const CharacterID: WideString) of object;
  TAgentListenComplete = procedure(ASender: TObject; const CharacterID: WideString; Cause: Smallint) of object;
  TAgentDefaultCharacterChange = procedure(ASender: TObject; const GUID: WideString) of object;
  TAgentActiveClientChange = procedure(ASender: TObject; const CharacterID: WideString; 
...
resourcestring
  dtlServerPage = 'ALXSystem';

  dtlOcxPage = 'ALXSystem';
...
procedure Register;
begin
  RegisterComponents(dtlOcxPage, [TAgent]);
end;
