inherited frmMasterMnt: TfrmMasterMnt
  Action = actAtualizaMasterMnt
  ActiveControl = edtPesquisaMasterMnt
  ...
  OnClick = actAtualizaMasterMntExecute
  ...
  object DbGridMasterMnt: TDBAdvGrid [1]
    Left = 0
    Top = 23
    Width = 784
    Height = 499
    ...
    ScrollBars = ssBoth
    TabOrder = 2
    OnDblClick = DbGridMasterMntDblClick
    ActiveRowShow = True
  ...
  object pnlRodape: TAdvSmoothPanel [2]
    Left = 0
    Top = 522
    Width = 784
    Height = 23
    ...
    Align = alBottom
    TabOrder = 1
    object btnSairMasterMnt: TAdvGlowButton
      Left = 709
      Top = 0
      Width = 75
      Height = 23
      Hint = 'Fecha o formul'#225'rio de manuten'#231#245'es'
      Align = alRight
      Caption = '&Sair'
      ImageIndex = 3
  ...
  object pnlCabecalho: TAdvSmoothPanel [3]
    Left = 0
    Top = 0
    Width = 784
    Height = 23
    ...
    Align = alTop
    TabOrder = 4
    object edtPesquisaMasterMnt: TEdit
      Left = 0
      Top = 0
      Width = 273
      Height = 23
      Align = alLeft
      TabOrder = 0
      OnChange = edtPesquisaMasterMntChange
      ExplicitHeight = 21
    end
    object edtRegistroSelecionado: TDBEdit
      Left = 273
      Top = 0
      Width = 371
      Height = 23
    ...
    object edtTotalRegistros: TJvEdit
      Left = 644
      Top = 0
      Width = 40
      Height = 23
    ...
    object btnIncluirMasterMnt: TAdvGlowButton
      Left = 684
      Top = 0
      Width = 25
      Height = 23
      ...
      ShowHint = True
      TabOrder = 3
      OnClick = btnIncluirMasterMntClick
      Appearance.ColorChecked = 16111818
      Appearance.ColorCheckedTo = 16367008
      Appearance.ColorDisabled = 15921906
      Appearance.ColorDisabledTo = 15921906
    ...
    object btnAlterarMasterMnt: TAdvGlowButton
      Left = 709
      Top = 0
      Width = 25
      Height = 23
      ...
      ShowHint = True
      TabOrder = 4
      OnClick = btnAlterarMasterMntClick
      Appearance.ColorChecked = 16111818
      Appearance.ColorCheckedTo = 16367008
      Appearance.ColorDisabled = 15921906
      Appearance.ColorDisabledTo = 15921906
    ...
    object btnExcluirMasterMnt: TAdvGlowButton
      Left = 734
      Top = 0
      Width = 25
      Height = 23
      ...
      ShowHint = True
      TabOrder = 5
      OnClick = btnExcluirMasterMntClick
      Appearance.ColorChecked = 16111818
      Appearance.ColorCheckedTo = 16367008
      Appearance.ColorDisabled = 15921906
      Appearance.ColorDisabledTo = 15921906
    ...
    object btnExcluirTodosMasterMnt: TAdvGlowButton
      Left = 759
      Top = 0
      Width = 25
      Height = 23
      Hint = 'Exclui todos os registros'
      Align = alRight
      ImageIndex = 5
      Images = ImageListMaster
      NotesFont.Charset = DEFAULT_CHARSET
      ...
      ShowHint = True
      TabOrder = 6
      OnClick = btnExcluirTodosMasterMntClick
      Appearance.ColorChecked = 16111818
      Appearance.ColorCheckedTo = 16367008
      Appearance.ColorDisabled = 15921906
      Appearance.ColorDisabledTo = 15921906
  ...
  object actLstAtualizaMasterMnt: TActionList
    Left = 144
    Top = 112
    object actAtualizaMasterMnt: TAction
      Caption = 'actAtualiza'
      OnExecute = actAtualizaMasterMntExecute
      OnUpdate = actAtualizaMasterMntUpdate
    end
  end
  object dtsMasterMnt: TDataSource
    OnDataChange = dtsMasterMntDataChange
    Left = 144
    Top = 176
  end
end
