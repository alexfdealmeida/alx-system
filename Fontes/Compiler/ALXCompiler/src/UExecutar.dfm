inherited frmExecutar: TfrmExecutar
  ActiveControl = edtPesquisa
  Caption = 'Selecione os m'#243'dulos que deseja executar...'
  ClientHeight = 570
  ClientWidth = 577
  ...
  object DBAdvGrid1: TDBAdvGrid [2]
    Left = 0
    Top = 21
    Width = 577
    Height = 489
  ...
  object pnlBotoes: TAdvSmoothPanel [3]
    ...
    object btnExecutar: TAdvGlowButton
      Left = 423
      Top = 8
      Width = 75
      Height = 25
      Hint = 'Executa os m'#243'dulos selecionados'
      Anchors = [akRight, akBottom]
      Caption = '&Executar'
      ImageIndex = 6
      Images = ImageListMaster
  ...
  object dtsModulosExe: TDataSource
    DataSet = dmExecutar.cdsModulosExe
    Left = 232
    Top = 80
  end
end
