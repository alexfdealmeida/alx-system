inherited frmSelecionaModulos: TfrmSelecionaModulos
  ActiveControl = edtPesquisa
  Caption = 'Selecione os m'#243'dulos que deseja compilar...'
  ClientHeight = 570
  ClientWidth = 577
  ...
  object DBAdvGrid1: TDBAdvGrid [2]
    ...
    DataSource = dtsSelecionaModulos
  ...
  object dtsSelecionaModulos: TDataSource
