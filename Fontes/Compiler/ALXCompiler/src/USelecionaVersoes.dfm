inherited frmSelecionaVersoes: TfrmSelecionaVersoes
  ActiveControl = edtPesquisa
  Caption = 'Selecione a vers'#227'o desejada...'
  ClientHeight = 570
  ClientWidth = 445
  ...
  object DBAdvGrid1: TDBAdvGrid [1]
    Left = 0
    Top = 21
    Width = 445
    Height = 489
    ...
    Columns = <
      ...
      item
        ...
        Font.Name = 'Tahoma'
        Font.Style = []
        Header = 'Descri'#231#227'o da Vers'#227'o'
        HeaderFont.Charset = DEFAULT_CHARSET
        HeaderFont.Color = clWindowText
        HeaderFont.Height = -11
        HeaderFont.Name = 'Tahoma'
    ...
    DataSource = dtsSelecionaVersoes
  ...
  object dtsSelecionaVersoes: TDataSource
