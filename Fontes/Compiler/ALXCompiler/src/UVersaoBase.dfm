inherited frmVersaoBase: TfrmVersaoBase
  ...
  Caption = 'Selecione a vers'#227'o base...'
  ClientHeight = 530
  ClientWidth = 159
  ExplicitWidth = 165
  ExplicitHeight = 554
  ...
  object pnlBotoes: TAdvSmoothPanel [2]
    Left = 0
    Top = 470
    Width = 159
    Height = 41
  ...
  object dtsVersaoTemp: TDataSource
    DataSet = dmVersaoBase.cdsVersoesTemp
    Left = 32
    Top = 56
  end
end
