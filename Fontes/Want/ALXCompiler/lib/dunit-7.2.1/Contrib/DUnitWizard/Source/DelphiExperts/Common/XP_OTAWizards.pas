...
//////////////////////////////////////////////////////////////////////////////
  ...
  TXP_OTAWizard = class(TNotifierObject, IOTAWizard)
  protected
...
uses
  SysUtils,       // FmtStr()
  XP_OTAUtils;    // ExtractWhiteSpace()

const CVSID: string = '$Header: /cvsroot/dunit/dunit/Contrib/DUnitWizard/Source/DelphiExperts/Common/XP_OTAWizards.pas,v 1.1 2003/07/29 12:54:37 pvspain Exp $';
