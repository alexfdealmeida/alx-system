...
const CVSID: string = '$Header: /cvsroot/dunit/dunit/Contrib/DUnitWizard/Source/DelphiExperts/DUnitProject/XPParserFilters.pas,v 1.1 2003/07/29 12:54:37 pvspain Exp $';
    ...
    begin
      ...
      while SourceClass.Children.Next(SourceVisibility) do
        if (SourceVisibility as IXPVisibilityNode).GetVisibility
          <> cvPrivate then
          System.Inc(SourceMethodCount, SourceVisibility.ChildCount);

      // Exclude empty classes

      if SourceMethodCount = 0 then
        continue;
...
var
  ...
  SourceVisibility: IXPParserNode;
  SourceMethod: IXPParserNode;
  EnabledSourceMethodCount: integer;
  FilterSection: IXPSectionNode;
  FilterClass: IXPClassNode;
  FilterVisibility: IXPVisibilityNode;
