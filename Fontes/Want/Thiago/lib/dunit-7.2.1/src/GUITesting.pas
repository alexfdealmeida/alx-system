{ #(@)$Id: GUITesting.pas,v 1.34 2004/04/29 18:52:46 juanco Exp $ }
{: DUnit: An XTreme testing framework for Delphi programs.
   @author  The DUnit Group.
   @version $Revision: 1.34 $ 2001/03/08 uberto
}
(*
...
const
  rcs_id: string = '#(@)$Id: GUITesting.pas,v 1.34 2004/04/29 18:52:46 juanco Exp $';
