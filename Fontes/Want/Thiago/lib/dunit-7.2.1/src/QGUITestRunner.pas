{ $Id: QGUITestRunner.pas,v 1.12 2003/06/01 20:35:06 neuromancer Exp $ }
{: DUnit: An XTreme testing framework for Delphi programs.
  @author  The DUnit Group.
  @version $Revision: 1.12 $ 2001/03/08 uberto
}
(*
...
begin
  ...
  begin
    if (NodeToTest(node) as IUnknown) = (test as IUnknown) then
   begin
    FoundNode := node;
    break;
   end;
