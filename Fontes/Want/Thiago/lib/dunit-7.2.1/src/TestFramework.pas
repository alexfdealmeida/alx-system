{#(@)$Id: TestFramework.pas,v 1.105 2004/04/29 18:52:46 juanco Exp $ }
...
const
  rcs_id: string = '#(@)$Id: TestFramework.pas,v 1.105 2004/04/29 18:52:46 juanco Exp $';
  rcs_verion : string = '$Revision: 1.105 $';
