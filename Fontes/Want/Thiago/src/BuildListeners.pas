...
const
  rcs_id :string = '#(@)$Id: BuildListeners.pas,v 1.6 2003/05/14 22:13:43 hippoman Exp $';
...
type
  ...
  protected
    ...
    procedure LogLine(ScriptElement: TScriptElement; Msg: string; Level: TLogLevel = vlNormal);    virtual;
  public
    constructor Create;

    procedure Log(ScriptElement: TScriptElement; Level: TLogLevel; Msg: string = '');              override;
...
procedure TBasicListener.Log(ScriptElement: TScriptElement; Level: TLogLevel; Msg: string);
var
  Lines     :TStringList;
  i         :Integer;
begin
  ...
  begin
    ...
    try
      ...
      begin
        LogLine(ScriptElement, Lines[i], Level);
      end;
    finally
      Lines.Free;
    end;
...
procedure TBasicListener.LogLine(ScriptElement: TScriptElement; Msg: string; Level: TLogLevel);
begin
  // do nothing
end;
