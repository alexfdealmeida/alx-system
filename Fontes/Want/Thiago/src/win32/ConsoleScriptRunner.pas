...
const
  rcs_id :string = '#(@)$Id: ConsoleScriptRunner.pas,v 1.10 2003/05/14 22:13:46 hippoman Exp $';
...
begin
  try
    ...
    on e :Exception do
    begin
      Listener.Log(Project, vlErrors, e.Message);
      raise;
    end;
  end;
end;
...
begin
  ...
  begin
    ...
    Log(Project, vlDebug, 'Parsing commandline');
  end
